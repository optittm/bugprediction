...
class Metric(Base):
    ...
    pylint_fan_out = Column(Integer)
    pylint_dit = Column(Float)
    pylint_noc = Column(Integer)
    pylint_nom = Column(Float)
    pylint_nof = Column(Integer)
    pylint_num_field = Column(Float)
    ...
    pylint_num_variable = Column(Float)
    pylint_num_inner_cls_and_lambda = Column(Float)
    pylint_num_docstring = Column(Float)
    pylint_num_import = Column(Float)
