...
class Metric(Base):
    ...
    radon_halstead_h1_total = Column(Integer)
    radon_halstead_h1_avg = Column(Float)
    radon_halstead_h2_total = Column(Integer)
    radon_halstead_h2_avg = Column(Float)
    radon_halstead_n1_total = Column(Integer)
    radon_halstead_n1_avg = Column(Float)
    radon_halstead_n2_total = Column(Integer)
    radon_halstead_n2_avg = Column(Float)
    radon_halstead_vocabulary_total = Column(Integer)
    radon_halstead_vocabulary_avg = Column(Float)
    radon_halstead_length_total = Column(Integer)
    radon_halstead_length_avg = Column(Float)
    radon_halstead_calculated_length_total = Column(Float)
    radon_halstead_calculated_length_avg = Column(Float)
    radon_halstead_volume_total = Column(Float)
    radon_halstead_volume_avg = Column(Float)
    radon_halstead_difficulty_total = Column(Float)
    radon_halstead_difficulty_avg = Column(Float)
    radon_halstead_effort_total = Column(Float)
    radon_halstead_effort_avg = Column(Float)
    radon_halstead_time_total = Column(Float)
    radon_halstead_time_avg = Column(Float)
    radon_halstead_bugs_total = Column(Float)
    radon_halstead_bugs_avg = Column(Float)
    # radon calculated
