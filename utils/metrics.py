...
class MetricFactory:
    ...
    def predict_bugs_language(project_id,
        ...
        if str(language).lower() == "java":
            ...
            return session.query(Version.avg_team_xp, Version.bug_velocity, Version.bugs,
            ...
            return session.query(Metric.pdepend_cbo, Metric.pdepend_fan_out, Metric.pdepend_dit, 
            ...
            return session.query(Metric.radon_cc_total, Metric.radon_cc_avg, Metric.radon_loc_total,
